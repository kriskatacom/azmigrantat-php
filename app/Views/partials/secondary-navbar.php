...
<nav x-data="{ sidebarOpen: false }" @keydown.escape="sidebarOpen = false" class="z-40 fixed top-0 left-0 w-full px-6 py-4 flex flex-col transition-colors bg-primary-dark/50 duration-500">
