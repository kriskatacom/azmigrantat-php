...
<section class="relative h-180 md:h-200 flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-5 text-center text-white">
        <h1 class="text-4xl md:text-6xl font-bold mb-6 italic font-serif [text-shadow:0_4px_8px_rgba(0,0,0,0.8)]">
            <?= HelperService::getTranslation($country, 'name') ?>
        </h1>
        <div class="mt-12">
            <a href="#" class="inline-block border-2 border-white text-white font-semibold px-12 py-5 rounded-lg text-2xl [text-shadow:0_2px_4px_rgba(0,0,0,0.8)] hover:bg-white hover:text-black hover:text-shadow-none transition-all duration-300 shadow-2xl">
                Научете повече
            </a>
        </div>
    </div>
