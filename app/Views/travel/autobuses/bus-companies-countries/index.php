...
// Вземаме преводите точно по твоя модел
...
if (!empty($countries)) {
    foreach ($countries as &$country) {
        ...
        $country['url'] = '/travel/autobuses/bus-companies-countries/' . $country['slug'];
    }
}
?>
...
<main>
    <?php View::component('load-more-grid', 'partials', [
        'items'     => $countries,
        'card_name' => 'item-card',
        'base_url'  => '/travel/autobuses/bus-companies-countries',
    ]); ?>
</main>
